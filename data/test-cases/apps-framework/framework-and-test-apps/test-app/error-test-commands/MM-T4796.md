...
On 2. "_failed to invoke via HTTP: TEST ERROR 500_" in shown in red text below the input box.
On 3. "_failed to invoke via HTTP: TEST ERROR 500_" in shown in red text below the RHS input box
