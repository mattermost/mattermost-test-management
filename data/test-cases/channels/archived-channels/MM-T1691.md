...
1. Have **users** make a post that includes a mention to **UserB** in one of the channels that **UserB** is a member of
2. Have **UserB** login on the mobile app to the server where the mention is located
3. Have **users** archive the channel with the mention
