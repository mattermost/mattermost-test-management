...
1. users create a new channel
2. users create a post and "@mention" UserB who does not belong to the channel
...
1. users add UserB to the channel
2. users create a post and "@mention" UserB
