---
key: MM-T2509
title: When a user leaves/is removed from a channel, that change is reflected in the search.
---
...
> <article>When a user leaves/is removed from a channel, that change is reflected in the search.<br>————————————————————————————<ol><li>UserA create a new channel</li><li>UserA create a post and "@mention" UserB who belongs to the channel</li></ol></article>
...
> <article><ol><li>UserA remove UserB from the channel</li><li>UserA create a post and "@mention" UserB</li></ol></article>
