...
2. As a regular user click the `Add Channels` CTA on the RHS which should display a small menu with 2 items on it
...
4. As the regular user click the `Add Channels` CTA on the RHS which should open the `More channels` modal directly and not display any menu under the CTA
