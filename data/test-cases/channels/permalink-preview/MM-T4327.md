...
2. Add **users,**\*\* \*\***userB** and \*\*userC \*\*in both \*\*ChannelPB \*\*and **ChannelPR**
3. Create GM with **users **and**** ****userB** **(i.e send direct message to **users **and****** ****userB** )****
...
7. Login as **users** and navigate to **ChannelPB**
...
7\. Permalink preview will be displayed to **users**\
