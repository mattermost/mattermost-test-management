...
> <article>Enable Bot<br>————————————————————————————<br>1. Navigate to the Bot accounts from the Integrations tab<br>2. Click Enable on one of the active bot</article>

**Expected**

> <article>The Bot is listed alphabetiacally with other active Bots</article>
