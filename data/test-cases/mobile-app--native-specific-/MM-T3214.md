...
> <article>Edit GM header<br>————————————————————————————<ol><li>On a GM channel, tap the users' names at the top</li><li> Tap `Edit Channel`, verify Save button is dimmed until changes are made</li><li> Type text in Header field</li><li>Tap Save</li></ol></article>
