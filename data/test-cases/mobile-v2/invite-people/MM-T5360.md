...
2. Tapping 'Invite people to the team' in the menu opens a form that fills the screen
    ...
    • Tapping the 'Share link' button the top right dimisses the screen and opens up the system sharing options at the bottom of the screen

**Expected**

    • Everything works as expected to that point
