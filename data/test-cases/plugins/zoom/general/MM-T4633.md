---
key: MM-T4633
title: Launch a meeting via slash command with a connected user
---
...
> <article>1. Enable Account Level oAuth and have a sysadmin connect to your Zoom app (see above)<br />2. Login as any user with an email address that is valid to use with your Zoom app<br />3. Type /zoom start</article>
