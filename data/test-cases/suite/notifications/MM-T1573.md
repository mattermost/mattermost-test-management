...
1. On mobile app, view channelA (we'll call you users)
...
4. Ensure users is in that channelB, or add them to it
5. While viewing mobile app as users, have userB post `@all` in that channelB twice in quick succession
...
- users sees two in-app notifications at the top of the screen, one after the other
