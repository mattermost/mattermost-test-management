...
1. As the Admin, disable Public and Private channel creation for `All Members` located in `System Console ➜ User Mangement ➜ Permissions`
2. Log in to a regular user account you have access to
3. As that user verify that the menu item to create from a template is **not** present in the onboarding task list or the ➕ menu at the top of the LHS
